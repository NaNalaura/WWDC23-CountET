            ...
            if screen == "correct" {
                ...
                ZStack{
                    ...
                    VStack{
                        ...
                        NavigationLink("", destination: Gameplay_3(data:Asteroids().randomOffsets()), isActive: $isNavigating)
                ...
                ZStack{
                    ...
                    VStack{
                        ...
                        NavigationLink("", destination: Gameplay_2(data:Asteroids().randomOffsets()), isActive: $isNavigating)
                        Button(action: {isNavigating = true}) {
                            ZStack{
                                Rectangle()
                                    .frame(width: 338, height: 45)
...
struct Gameplay_2_Previews: PreviewProvider {
    static var previews: some View {
        Gameplay_2(data: Asteroids())
    }
}
