...
struct Gameplay_1: View {
 ...
 //PERGUNTAR
                            ...
                            HStack{
                                ...
                                ZStack{
                                    ...
                                    VStack(alignment: .leading){
                                        Text("Wow! You are very smart, I knew I could count on you!")
                                            .padding(.top, 158)
                                            .padding(.trailing, 30)
                                            .padding(.leading, 143)
                                            .padding(.bottom, 37)
            ...
            .background(MyApp.colorpallet(n: 5))
            
    }
}


struct Gameplay_1_Previews: PreviewProvider {
    static var previews: some View {
        Gameplay_1(data: Asteroids())
    }
}
