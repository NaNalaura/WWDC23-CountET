            ...
            if screen == "correct" {
                ZStack{
                    ...
                    VStack{
                            ...
                            HStack{
                                ...
                                ZStack{
                                    ...
                                    VStack(alignment: .leading){
                                        Text("I think we're halfway there, if it wasn't for you I wouldn't get off the ground, hehe...")
                                            .padding(.top, 105)
                                            .padding(.trailing, 30)
                                            .padding(.leading, 143)
                                            .padding(.bottom, 37)
                        ...
                        NavigationLink("", destination: Gameplay_5(data:Asteroids().randomOffsets()), isActive: $isNavigating)
                ...
                ZStack{
                    ...
                    VStack{
                        ...
                        NavigationLink("", destination: Gameplay_4(data:Asteroids().randomOffsets()), isActive: $isNavigating)
                        Button(action: {isNavigating = true}) {
                            ZStack{
                                Rectangle()
                                    .frame(width: 338, height: 45)
...
struct Gameplay_4_Previews: PreviewProvider {
    static var previews: some View {
        Gameplay_4(data: Asteroids())
    }
}
